...
function InsertUpdateAddSubCategory() {
    try {
        $.post("/Machine/InsertUpdateAddSubCategory",
            {
...
function ShowAddSubProductCategory() {
    try {
        $.post("/Machine/ShowAddSubProductCategory", {}, function (data) {
            if (data.Message != "") {
                alert(data.Message);
            }
            if (data.Grid != "") {
...
function DelAddSubProductCategory(AddSubCateId) {
    try {
        if (confirm("do you want to Delete?")) {
            $.post("/Machine/DelAddSubProductCategory", { AddSubCateId: AddSubCateId }, function (data) {
                if (data.Message != "") {
                    alert(data.Message);
                    ShowAddSubProductCategory();
                }
...
function EditAddSubProductCategory(SubCateId) {
    try {
        $.post("/Machine/EditAddSubProductCategory", { AddSubCateId: SubCateId }, function (data) {
            if (data.Message != "") {
                alert(data.Message);
            }
            else {
