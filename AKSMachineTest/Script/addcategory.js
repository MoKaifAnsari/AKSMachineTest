...
function InsertUpdateAddCategory() {
    try {
        $.post("/Machine/InsertUpdateAddCategory",
            {
...
function showAddCategory() {
    try {
        $.post("/Machine/showAddCategory", {}, function (data) {
            if (data.Message != "") {
                alert(data.Message);
            }
            if (data.Grid != "") {
...
function Delete(AddCategoryId) {
    try {
        if (confirm("Really.. Do you want to Delete this record?")) {
            $.post("/Machine/Delete", { AddCategoryId: AddCategoryId }, function (data) {
                if (data.Message != "") {
                    alert(data.Message);
                    showAddCategory();
                }
...
function Edit(ID) {
    try {
        $.post("/Machine/Edit", { AddCategoryId: ID }, function (data) {
            if (data.Message != "") {
                alert(data.Message);
            }
            else {
